...
void huansic_led1_turn(void);

void huansic_led2_turn(void);

void huansic_led3_turn(void);

void huansic_led4_turn(void);

void huansic_led5_turn(void);

void huansic_led6_turn(void);

void huansic_led7_turn(void);
