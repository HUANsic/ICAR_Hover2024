...
void OLED_W_SCL(uint8_t BitValue)
{
	...
	GPIO_WriteBit(GPIOD, GPIO_Pin_15, (BitAction)BitValue);
	GPIO_WriteBit(GPIOD, GPIO_Pin_13, (BitAction)BitValue);
...
void OLED_W_SDA(uint8_t BitValue)
{
	...
	GPIO_WriteBit(GPIOD, GPIO_Pin_14, (BitAction)BitValue);
	GPIO_WriteBit(GPIOD, GPIO_Pin_12, (BitAction)BitValue);
	/*如果单片机速度过快，可在此添加适量延时，以避免超出I2C通信的最大速度*/
	//...
}
