...
const UINT8 OV2640_InitRegTbl[][2]=
{
	...
	0x13, 0xe5,
	//0x13, 0xe0,                //Bit[2]:AGC 0:M 1:A, Bit[0] Exposure Control 0:M 1:A
	...
	0x24, 0x40,
	//0x24, 0xff,                //Max M Luminance

	0x25, 0x38,
	//0x25, 0x00,                //Min M Luminance
...
//	0x12, 0x00,
	0x12, 0x00,                 //Bit[6:4]:resolution selection 000:UXGA(full size) 001:CIF 100:SVGA
...
{
	OV2640_RGB565_Mode();
	//OV2640_ImageSize_Set(OV2640_RGB565_WIDTH,OV2640_RGB565_HEIGHT);
	//OV2640_ImageWin_Set(0,0,OV2640_RGB565_WIDTH+20,OV2640_RGB565_HEIGHT+20);
//	OV2640_OutSize_Set(OV2640_RGB565_WIDTH,OV2640_RGB565_HEIGHT);

	OV2640_Window_Set(274, 4, 800, 600);
	OV2640_ImageSize_Set(800, 600);
	OV2640_ImageWin_Set(0, 0, 800, 300);
	OV2640_OutSize_Set(400, 300);


	OV2640_Speed_Set(28,0);
...
//        SCCB_WR_Reg(OV2640_YUV422RegTbl[i][0],OV2640_YUV422RegTbl[i][1]);
//    }
//	for(i=0;i<(sizeof(OV2640_400X300_60D0)/2);i++)
//    {
//        SCCB_WR_Reg(OV2640_400X300_60D0[i][0],OV2640_400X300_60D0[i][1]);
//    }
}
...
UINT8 OV2640_OutSize_Set(UINT16 Image_width,UINT16 Image_height)
{
	...
	SCCB_WR_Reg(0XE0,0X04);             //reset
	SCCB_WR_Reg(0X5A,Out_Size_Width&0XFF);  //OUTW[7:0](real/4)
	SCCB_WR_Reg(0X5B,Out_Size_Height&0XFF); //OUTH[7:0](real/4)
	t=(Out_Size_Width>>8)&0X03;
	t|=(Out_Size_Height>>6)&0X04;
	SCCB_WR_Reg(0X5C,t);                //Bit[2]:OUTH[8] Bit[1:0]:OUTW[9:8]
